...
- `ROOM_REVIEW_baseline_v0_1.yaml`: baseline Level 3 room-aware review spec covering dimensions, surface treatment, reflection policy, renderer adaptation hints, listening zones, and speaker placement
...
That review payload is intentionally non-trivial: it should surface room dimension, surface-profile, surface-treatment, reflection-policy, renderer-adaptation, listening-zone, and speaker-placement drift in one compact batch-review document.
