...
- initial support can now preserve validated room-aware context through top-level `room` metadata covering room dimensions, surface profile, reflection policy, renderer adaptation hints, listening zones, and initial speaker placement
