...
- initial support can now preserve validated room-aware context through top-level `room` metadata covering room dimensions, surface profile, reflection policy, listening zones, and initial speaker placement
